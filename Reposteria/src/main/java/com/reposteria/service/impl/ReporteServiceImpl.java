...
public class ReporteServiceImpl implements ReporteService {
    ...
    public ResponseEntity<Resource> generarReporte(String reporte, Map<String, Object> parametros, String tipo) throws IOException {
        ...
        try {
            ...
            try (InputStream elReporte = fuente.getInputStream()) {
                JasperPrint reporteJasper = JasperFillManager.fillReport(elReporte, parametros, datasource.getConnection());
                ...
                switch (tipo) {
                    ...
                    default -> { /* Manejar otro caso si es necesario */ }
                }
